...
public class Titanic_PCAFilter {


    static String dataSetPath = "dataset/dimension_reduce/titanic.arff";
    static String saveDataSetPath = "dataset/other/filtered/titanic.arff";
